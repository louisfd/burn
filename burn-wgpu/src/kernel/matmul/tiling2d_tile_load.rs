...
kernel_wgsl!(
    MatmulTiling2DTileLoadRaw,
    "../../template/matmul/blocktiling_2d/tile_load.wgsl"
);

struct MatmulTiling2DTileLoad<
    const B_M: usize,
    const B_N: usize,
    const B_K: usize,
    const T_M: usize,
...
impl<
        ...
        const WORKGROUP_SIZE_Y: usize,
    > StaticKernel
    for MatmulTiling2DTileLoad<B_M, B_N, B_K, T_M, T_N, WORKGROUP_SIZE_X, WORKGROUP_SIZE_Y>
{
    fn source_template() -> SourceTemplate {
        MatmulTiling2DTileLoadRaw::source_template()
...
>(
    ...
    let kernel = lhs.context.compile_static::<KernelSettings<
        MatmulTiling2DTileLoad<B_M, B_N, B_K, T_M, T_N, WORKGROUP_SIZE_X, WORKGROUP_SIZE_Y>,
        E,
        i32,
        WORKGROUP_SIZE_X,
        WORKGROUP_SIZE_Y,
